<template>
    <div id="servers">
        ...
        <div class="servers-container">
            ...
            <div class="server-list">
                <v-card v-for="server of servers" :key="server.id" :id="server.id" class="server bg-grey-darken-4">
                    <v-card-title>${name}</v-card-title>
                    <v-card-subtitle>${type} ${version} (ID: ${id})</v-card-subtitle>
                    <v-card-text>
                        <p>Port: ${port}</p>
                        <p>Status: Offline</p>
                    </v-card-text> 
    ...
    <div id="server-item" style="display: none">
        <console-page v-if="selectedServer" :id="selectedServer" />
    </div>
</template>
